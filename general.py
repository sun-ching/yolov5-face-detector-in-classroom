...
def xyxy2xywh(x):
    ...
    y[:, 3] = x[:, 3] - x[:, 1]  # height
    return y
## Convert nx4 boxes from [x1, y1, x2, y2] to [x_left, y_left, w, h] where xy1=top-left, xy2=bottom-right
def xywh2x1y1wh(x):
...
def non_max_suppression(prediction, conf_thres=0.1, iou_thres=0.6, merge=False, classes=None, agnostic=False):
    ...
    # Settings
    min_wh, max_wh = 2, 4096000  # (pixels) minimum and maximum box width and height
    max_det = 100000# maximum number of detections per image
