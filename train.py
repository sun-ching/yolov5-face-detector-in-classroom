...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/suncheng/yolov5_facedetection/models/EPSAL-add2-anchor.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/word.yaml', help='data.yaml path')
